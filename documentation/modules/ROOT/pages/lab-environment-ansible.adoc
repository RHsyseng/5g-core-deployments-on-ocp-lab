...
CAUTION: If you are a Red Hatter, you can order a lab environment on the https://demo.redhat.com[Red Hat Demo Platform]. You just need to order the lab named `5G Core Deployment on OpenShift`.
...
[#role-overview]
== OCP4 5G Core Role Overview

This role https://github.com/RHsyseng/agnosticd/tree/development/ansible/roles_ocp_workloads/ocp4_workload_5gran_deployments_lab[ocp4_workload_5gran_deployments_lab] installs the 5G Core RDS Deployments Lab environment. It consists of the following tasks files:
...
* The https://github.com/RHsyseng/agnosticd/blob/development/ansible/roles_ocp_workloads/ocp4_workload_5gran_deployments_lab/defaults/main.yml[defaults/main.yml] file contains the default configuration variables for the 5G Core lab deployment.
...
The https://github.com/RHsyseng/agnosticd/blob/development/ansible/roles_ocp_workloads/ocp4_workload_5gran_deployments_lab/tasks/pre_workload.yml[ pre_workload.yml] file contains the initial setup and preparation tasks that must be completed before deploying the 5G Core RDS lab environment. This file ensures your hypervisor is properly configured with all necessary dependencies, services, and infrastructure components. 
...
IMPORTANT: The pre-workload phase is essential for creating a properly configured environment that can successfully deploy and run the 5G Core lab workloads.

[#workload-tasks-overview]
== Workload Tasks Overview

The `workload.yml` file contains the main deployment tasks that create and configure the 5G Core lab environment. This file deploys OpenShift clusters, installs operators, and configures the infrastructure needed for 5G workloads.

[#what-workload-does]
=== What Workload Does

The workload phase deploys the complete 5G Core lab environment by:
...
The workload phase creates a complete 5G Core RDS lab environment ready for advanced telco workload deployment and testing. Once workload completes successfully, the system provides:
...
5. **Ready environment** for 5G Core lab exercises.
